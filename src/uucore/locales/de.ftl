...
selinux-error-context-conversion-failure = Fehler beim Einstellen des Standardkontexts für die Dateierstellung auf '{ $context }': { $error }
...
smack-error-label-set-failure = Fehler beim Einstellen des Standardkontexts für die Dateierstellung auf '{ $context }': { $error }
smack-error-no-label-set = kein Sicherheitskontext eingestellt
...
common-write-error = Schreibfehler
