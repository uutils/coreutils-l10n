...
csplit-diag-help-pattern = un motif est un numéro de ligne N, /REGEXP/[DÉCALAGE] ou %REGEXP%[DÉCALAGE], chacun pouvant être suivi de { "{" }N{ "}" } ou { "{" }*{ "}" }
csplit-diag-help-line-number = les numéros de ligne commencent à 1 et ne doivent pas décroître d'un motif au suivant
csplit-diag-help-digits = --digits prend un nombre décimal de chiffres, comme dans -n 3
csplit-diag-help-suffix-format = un format de suffixe est une seule conversion printf pour un entier non signé, comme dans %03u
