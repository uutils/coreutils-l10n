...
shred-removed = { $file }: borttagen
shred-renamed-to = bytt namn till
shred-pass-progress = { $file }: passering
shred-couldnt-rename = { $file }: Kunde inte byta namn till { $new_name }: { $error }
shred-failed-to-open-for-writing = { $file }: kunde inte öppnas för skrivning
shred-file-write-pass-failed = { $file }: Filskrivning misslyckades
shred-failed-to-remove-file = { $file }: misslyckades med att ta bort filen
