...
shred-failed-to-open-for-writing-not-a-directory = { $file }: nie udało się otworzyć do zapisu: nie jest katalogiem
shred-failed-to-open-for-writing-is-a-directory = { $file }: nie udało się otworzyć do zapisu: jest katalogiem
shred-failed-to-clone-file-handle = nie udało się sklonować uchwytu pliku
shred-failed-to-seek-file = nie udało się wyszukać w pliku
shred-failed-to-read-seed-bytes = nie udało się odczytać bajtów zarodka z pliku
shred-failed-to-get-metadata = nie udało się pobrać metadanych pliku
shred-failed-to-set-permissions = nie udało się ustawić uprawnień do pliku
