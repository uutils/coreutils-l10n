...
pr-error-unknown-filetype = { $file }: tipo de ficheiro desconhecido
pr-error-is-directory = { $file }: é um diretório
...
pr-error-invalid-pages-range = inválido argumento de --pages '{ $start }:{ $end } '
