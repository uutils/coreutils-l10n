...
pinky-about-musl-warning =
    Advertencia: Cuando se compila con musl libc, la utilidad `pinky` puede mostrar información
...
pinky-long-usage-description =
    Un programa 'finger' ligero; imprime información del usuario.
...
pinky-help-lookup = intenta canonizar nombres de host por medio de DNS
