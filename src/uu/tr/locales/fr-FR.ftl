...
# Étiquettes de diagnostic : ce que le curseur désigne dans un ensemble
...
tr-diag-help-equivalence = [=c=] représente tous les caractères équivalents à c
tr-diag-help-repeat = [c*N] répète c N fois, [c*] complète SET2 à la longueur de SET1
tr-diag-help-backwards-range = une plage va du caractère le plus petit au plus grand, comme dans a-z
