...
sync-error-opening-file = błąd otwierania { $file }: { $err }
...
sync-error-syncing-file = błąd synchronizacji { $file }
sync-warning-fcntl-failed = ostrzeżenie: nie udało się zresetować flagi O_NONBLOCK dla { $file }: { $error }
