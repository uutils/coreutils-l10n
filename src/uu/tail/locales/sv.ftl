...
tail-no-such-file-or-directory = Fil eller katalog saknas
tail-is-a-directory = Är en katalog
tail-giving-up-on-this-name = ; slutar försöka med det här namnet
tail-stdin-header = standard-in
tail-no-files-remaining = inga filer kvar
tail-become-inaccessible = har blivit otillgänglig
