...
stdbuf-error-permission-denied = impossible d'exécuter le processus : Permission refusée
stdbuf-error-no-such-file = impossible d'exécuter le processus : Aucun fichier ou répertoire de ce type
stdbuf-error-failed-to-execute = impossible d'exécuter le processus : {$error}
