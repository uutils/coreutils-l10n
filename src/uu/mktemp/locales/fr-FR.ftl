...
mktemp-error-not-found = impossible de créer { $template_type } via le modèle { $template } : Aucun fichier ou répertoire de ce type
mktemp-error-failed-print = impossible d'afficher le nom de répertoire
