id-about =
    Mostrar información de usuario y grupo para cada USUARIO especificado,
    o (cuando se omite USUARIO) para el usuario actual.
id-usage = id [OPCIÓN]... [USUARIO]...
id-after-help =
    La utilidad id muestra los nombres de usuario y grupo e IDs numéricos, del
...
id-error-context-security-only = --context (-Z) solo funciona en un núcleo con SELinux/SMACK habilitado
