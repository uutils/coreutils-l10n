...
rm-after-help = Por defecto, rm no elimina directorios. Use la opción --recursive (-r o -R)
...
rm-help-prompt-once = avisar una vez antes de eliminar más de tres archivos, o al eliminar recursivamente.
  Menos intrusivo que -i, mientras aún da cierta protección contra la mayoría de errores
rm-help-interactive = avisar según CUÁNDO: never, once (-I), o always (-i). Sin CUÁNDO,
  avisa siempre
rm-help-one-file-system = al eliminar una jerarquía recursivamente, omitir cualquier directorio que esté en un sistema
...
# Error messages
rm-error-missing-operand = falta operando
