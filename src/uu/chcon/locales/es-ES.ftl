chcon-about =
    Cambiar el contexto de seguridad SELinux de cada ARCHIVO a CONTEXTO.
...
chcon-help-no-preserve-root = No tratar «/» especialmente (predeterminado).
...
chcon-error-invalid-context = Contexto de seguridad «{ $context }» no válido.
...
chcon-warning-circular-directory =
    Estructura de directorio circular.
