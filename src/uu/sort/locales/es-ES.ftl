...
sort-read-failed = falló la lectura: {$error}
...
sort-random-source-end-of-file = {$path}: fin de archivo
...
sort-invalid-field-spec = {$msg}: especificación de campo no válida {$spec}
sort-invalid-count-at-start-of = cuenta no válida al principio de {$string}
sort-invalid-number-at-field-start = número no válido al principio del campo
sort-invalid-number-after-dash = número no válido después de '-'
sort-invalid-number-after-dot = número no válido después de '.'
...
sort-warning-failed-to-set-locale = no se pudo establecer la configuración regional
sort-warning-simple-byte-comparison = ordenación de texto realizada mediante comparación simple de bytes
sort-warning-sort-rule = ordenación de texto realizada mediante las reglas de ordenación de ‘{$locale}’
sort-warning-key-zero-width = la clave {$key} tiene anchura cero y se ignorará
sort-warning-key-numeric-spans-fields = la clave {$key} es numérica y abarca varios campos
sort-warning-leading-blanks-significant = los espacios iniciales son significativos en la clave {$key}; considere especificar también 'b'
sort-warning-numbers-use-decimal-point = los números usan '.' como separador decimal en esta configuración regional
# Help messages
...
sort-help-random-source = usar ARCHIVO como fuente de datos aleatorios
...
sort-field-number-is-zero = el número de campo es cero
sort-character-offset-is-zero = el desplazamiento de carácter es cero
sort-stray-character-field-spec = carácter suelto en la especificación de campo
sort-diag-label-missing-count = se esperaba un número aquí
sort-diag-label-zero-count = la numeración empieza en 1
sort-diag-help-key-syntax = una clave es CAMPO[.CAR][OPC][,CAMPO[.CAR][OPC]], como en -k2.3,4nr
sort-warning-options-ignored = las opciones '-{ $options }' son ignoradas
sort-warning-option-ignored = la opción '-{ $option }' es ignorada
sort-warning-option-reverse-last-resort = la opción '-r' solo se aplica a la comparación de último recurso
sort-warning-obsolescent-key = se usó la clave obsolescente '{$key}'; considere '-k {$replacement}' en su lugar
sort-warning-separator-grouping = el separador de campos '{$sep}' se trata como separador de grupos en los números
sort-warning-separator-decimal = el separador de campos '{$sep}' se trata como separador decimal en los números
sort-warning-separator-minus = el separador de campos '{$sep}' se trata como signo menos en los números
sort-warning-separator-plus = el separador de campos '{$sep}' se trata como signo más en los números
