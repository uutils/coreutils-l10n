...
sort-maximum-batch-size-rlimit = maksimuma argumento por --batch-size kun la aktuala resurslimo estas { $rlimit }
sort-failed-fetch-rlimit = Malsukcesis akiri resurslimon
sort-help-parallel = lanĉi NUM_THREADS fadenojn paralele
sort-help-debug = subskribi tiujn partojn de linio, kiuj fakte uziĝas por ordigi
sort-minus-in-stdin = dosiernomo «-» ne estas permesata dum legado de dosiernomoj el la norma enfluo
