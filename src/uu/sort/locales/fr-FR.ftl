...
# Messages d'erreur
sort-open-failed = impossible d'ouvrir : {$path} : {$error}
sort-parse-key-error = impossible d'analyser la clé {$key} : {$msg}
sort-cannot-read = impossible de lire : {$path} : {$error}
sort-open-tmp-file-failed = impossible d'ouvrir le fichier temporaire : {$error}
...
sort-failed-parse-field-index = impossible d'analyser l'index de champ {$field} {$error}
sort-field-index-cannot-be-zero = l'index de champ ne peut pas être 0
sort-failed-parse-char-index = impossible d'analyser l'index de caractère {$char} : {$error}
...
sort-failed-fetch-rlimit = Impossible de récupérer rlimit
...
sort-error-write-failed = impossible d'écrire : {$output}
sort-failed-to-delete-temporary-directory = impossible de supprimer le répertoire temporaire : {$error}
sort-failed-to-set-up-signal-handler = impossible de configurer le gestionnaire de signal : {$error}
