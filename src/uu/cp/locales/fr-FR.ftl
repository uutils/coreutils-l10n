...
cp-error-cannot-create-regular-file = impossible de créer le fichier régulier { $path }
...
cp-error-setting-attributes = définition des attributs de { $path }
cp-error-write = erreur d'écriture
