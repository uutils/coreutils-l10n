...
cp-error-failed-to-clone = impossible de cloner { $source } depuis { $dest } : { $error }
...
cp-error-failed-get-current-dir = impossible d'obtenir le répertoire actuel { $error }
...
cp-error-selinux-set-context = impossible de définir le contexte de sécurité de { $path } : { $error }
cp-error-selinux-get-context = impossible d'obtenir le contexte de sécurité de { $path }
...
cp-error-failed-to-create-whole-tree = impossible de créer l'arborescence complète
cp-error-failed-to-create-directory = impossible de créer le répertoire : { $error }
