...
truncate-help-io-blocks = traktuje ROZMIAR jako liczbę bloków wejścia-wyjścia pliku, a nie bajtów
...
truncate-error-io-block-mul-overflow = przepełnienie w blokach bajtów { $num } * { $factor }
