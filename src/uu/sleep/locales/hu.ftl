sleep-about = Szüneteltetés megadott SZÁMÚ másodpercig.
sleep-usage =
    sleep SZÁM[UTÓTAG]...
    sleep KAPCSOLÓ
sleep-after-help =
    Szüneteltetés a megadott SZÁM másodpercig. Az UTÓTAG lehet 's'
    másodpercre (alapértelmezett), 'm' percre, 'h' órára vagy 'd' napra. A legtöbb
