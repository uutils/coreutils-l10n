sleep-about = Pause für NUMMER Sekunden.
sleep-usage =
    sleep NUMMER[SUFFIX]...
    sleep OPTION
sleep-after-help =
    Pause für NUMMER Sekunden. SUFFIX kann für Sekunden "s" sein (der Vorgabewert),
    'm' für Minuten, 'h' für Stunden oder 'd' für Tage. Im Gegensatz zu den meisten 
