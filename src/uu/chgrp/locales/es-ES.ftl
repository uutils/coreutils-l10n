...
chgrp-help-no-preserve-root = no tratar «/» especialmente (predeterminado)
...
# Error messages
chgrp-error-invalid-group-id = id. de grupo no válido: «{ $gid_str }»
chgrp-error-invalid-group = grupo no válido: «{ $group }»
chgrp-error-failed-to-get-attributes = falló al obtener atributos de { $file }
chgrp-error-invalid-user = usuario no válido: «{ $from_group }»
