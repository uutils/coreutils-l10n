...
od-after-help =
    Affiche les données dans divers formats lisibles par l'homme. Si plusieurs
    ...
    Si aucun nom de fichier n'est spécifié, ou si c'est "-", stdin sera utilisé. Après un "--",
    aucune autre option ne sera reconnue. Cela permet d'avoir des noms de
