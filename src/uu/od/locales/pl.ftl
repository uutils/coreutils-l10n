...
od-error-skip-past-end = nie można pominąć końca połączonych danych wejściowych
...
od-help-f = jednostki zmiennoprzecinkowe pojedynczej precyzji (32-bitowe)
od-help-capital-f = jednostki zmiennoprzecinkowe podwójnej precyzji (64-bitowe)
od-error-overflow = Wynik liczbowy poza zakresem
