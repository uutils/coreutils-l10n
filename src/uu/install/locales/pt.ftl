...
install-help-strip = remover tabelas de símbolos
install-help-strip-program = programa usado para fazer strip em binários
...
install-help-unprivileged = não requerer privilégios elevados para alterar o proprietário, o grupo ou os atributos de ficheiro do destino
install-error-strip-abnormal = o processo do strip foi terminado anormalmente - código de saída: { $code }
install-error-strip-failed = o programa strip falhou: { $error }
