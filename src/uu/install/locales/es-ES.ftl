...
install-help-strip = quitar tablas de símbolos
install-help-strip-program = programa usado para quitar símbolos de binarios
...
install-error-create-dir-failed = no se pudo crear el directorio { $path }
