...
split-help-numeric-suffixes = tak samo jak -d, ale pozwala na ustawienie wartości początkowej
split-help-hex-suffixes-short = używa sufiksów szesnastkowych zaczynających się od 0, a nie alfabetycznych
split-help-hex-suffixes = tak samo jak -x, ale pozwala na ustawienie wartości początkowej
