...
uniq-after-help =
    Filtrar líneas coincidentes adyacentes de ENTRADA (o entrada estándar),
...
uniq-error-counts-and-repeated-meaningless =
    mostrar todas las líneas duplicadas y conteos de repetición no tiene sentido
    Pruebe 'uniq --help' para más información.
uniq-error-could-not-open = No se pudo abrir { $path }
uniq-error-read-error = error de lectura
