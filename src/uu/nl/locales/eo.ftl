...
nl-help-header-numbering = uzi STYLE for numeri kapajn liniojn
nl-error-is-directory = { $path }: Estas dosierujo
nl-after-help =
    STYLE estas unu el:

    - a numeri ĉiujn liniojn
    - t numeri nur nemalplenajn liniojn
    - n numeri neniun linion
    - pBRE numeri nur la liniojn kongruajn kun la baza regula
            esprimo, BRE
...
nl-help-starting-line-number = unua linia numero ĉe ĉiu logika paĝo
nl-help-number-format = montri liniajn numerojn laŭ FORMAT
nl-help-no-renumber = ne rekomenci liniajn numerojn ĉe logikaj paĝoj
nl-help-join-blank-lines = grupo de NUMBER malplenaj linioj traktiĝas kiel unu linio
