...
who-about-musl-warning =
    Nota: Cuando se compila con musl libc, la utilidad `who` no mostrará ninguna
...
who-long-usage =
    Si ARCHIVO no se especifica, usar { $default_file }. /var/log/wtmp como ARCHIVO es común.
