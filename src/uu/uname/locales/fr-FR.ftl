...
uname-help-all-labeled = comme -a, afficher toutes les informations mais un élément par ligne, avec son étiquette.

# Étiquettes pour --all-labeled ; { $value } est la valeur fournie par le système.
