pwd-about = Mostrar el nombre completo del directorio de trabajo actual.
pwd-usage = pwd [OPCIÓN]...
...
pwd-error-failed-to-print-current-directory = falló al mostrar el directorio actual
