...
mv-usage = mv [OPCIÓN]... [-T] ORIGEN DESTINO
  mv [OPCIÓN]... ORIGEN... DIRECTORIO
  mv [OPCIÓN]... -t DIRECTORIO ORIGEN...
mv-after-help = Al especificar más de una de -i, -f, -n, solo la final tendrá efecto.
...
mv-help-progress = Mostrar una barra de progreso.
