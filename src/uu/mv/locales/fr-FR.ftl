...
mv-help-selinux = défini le contexte de sécurité SELinux du fichier de destination au type par défaut
mv-help-context = comme -Z, sauf si CTX est spécifié auquel cas le contexte de sécurité SELinux est défini sur CTX
mv-prompt-overwrite-mode = remplace { $target }, en remplaçant le mode { $mode_info } ?
