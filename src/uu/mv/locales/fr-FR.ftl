...
mv-help-selinux = définir le contexte de sécurité SELinux du fichier de destination au type par défaut
mv-help-context = comme -Z, ou si CTX est spécifié, définir le contexte de sécurité SELinux à CTX
...
mv-prompt-overwrite-mode = remplacer {$target}, en écrasant le mode {$mode_info} ?
