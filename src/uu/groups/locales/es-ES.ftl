groups-about = Mostrar membresías de grupo para cada NOMBREUSUARIO o, si no se especifica NOMBREUSUARIO, para
  el proceso actual (que puede diferir si la base de datos de grupos ha cambiado).
