ls-about = Listar contenido de directorios.
...
ls-error-invalid-time-style = argumento --time-style inválido {$style}
...
ls-help-long-format-no-group = Formato largo sin información de grupo.
...
ls-help-show-time-field = Mostrar tiempo en <campo>:
...
ls-help-time-change = Si se está usando el formato de listado largo (p. ej., -l, -o), mostrar el
...
ls-help-time-access = Si se está usando el formato de listado largo (p. ej., -l, -o), mostrar el
...
ls-help-sort-none = No ordenar; listar los archivos en cualquier orden en que estén almacenados en el
...
ls-help-dereference-all = Al mostrar información de archivo para un enlace simbólico, mostrar información para el
  archivo al que se refiere el enlace en lugar del enlace mismo.
ls-help-dereference-dir-args = No seguir enlaces simbólicos excepto cuando enlacen a directorios y sean
...
ls-help-author = Mostrar autor en formato largo. En las plataformas soportadas,
...
ls-help-almost-all = En un directorio, no ignorar todos los nombres de archivo que empiecen por '.',
  solo ignorar '.' y '..'.
ls-help-directory = Solo listar los nombres de directorios, en lugar de listar contenido de directorios.
...
ls-help-kibibytes = predeterminado a bloques de 1024 bytes para uso del sistema de archivos; usado solo con -s y por
...
ls-help-reverse-sort = Invertir cualquier método de ordenación, p. ej., listar archivos en orden
...
ls-help-indicator-style = Añadir indicador con estilo WORD a nombres de entrada:
  none (predeterminado), slash (-p), file-type (--file-type), classify (-F)
ls-help-classify = Añadir un carácter a cada nombre de archivo indicando el tipo de archivo. También, para
...
ls-help-group-directories-first = agrupar directorios antes que archivos; puede aumentarse con
