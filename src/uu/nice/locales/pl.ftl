...
nice-error-invalid-number = „{ $value }” nie jest prawidłową liczbą: { $error }
nice-warning-setpriority = { $util_name }: ostrzeżenie: setpriority: { $error }
nice-help-adjustment = dodawanie N do poziomu „niceness” (domyślnie 10)
