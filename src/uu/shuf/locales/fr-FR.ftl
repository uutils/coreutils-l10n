...
shuf-help-random-seed = initialiser avec CHAÎNE pour une sortie reproductible
...
shuf-error-read-random-bytes = échec de la lecture des octets aléatoires
shuf-error-end-of-random-bytes = fin de la source aléatoire
