...
shuf-help-random-seed = sembrar con CADENA para una salida reproducible
...
shuf-error-read-random-bytes = falló la lectura de bytes aleatorios
shuf-error-end-of-random-bytes = fin de la fuente aleatoria
...
shuf-error-memory-exhausted = memoria agotada
