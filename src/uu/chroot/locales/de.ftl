...
chroot-help-skip-chdir = Benutze diese Option, um das Arbeitsverzeichnis nicht in / zu ändern, nachdem das Wurzelverzeichnis in NEUES_WURZELVERZ geändert wurde, z.B. innerhalb des chroot.
