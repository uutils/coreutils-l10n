...
numfmt-help-debug = imprimir avisos sobre a entrada inválida
numfmt-help-unit-separator = usar CADEIA para separar o número de qualquer unidade ao imprimir; por predefinição, nenhum separador é usado
numfmt-error-grouping-cannot-be-combined-with-format = --grouping não pode ser combinado com --format
numfmt-error-invalid-specific-suffix = sufixo inválido na entrada { $input }: { $suffix }
numfmt-error-invalid-unit-argument = argumento '{ $arg }' inválido para '{ $opt } '
numfmt-debug-no-conversion = nenhuma opção de conversão especificada
numfmt-debug-grouping-no-effect = agrupamento não tem efeito neste locale
numfmt-debug-failed-to-convert = falha ao converter alguns dos números de entrada
numfmt-debug-header-ignored = --header ignorado com a entrada de linha de comando
numfmt-help-grouping = usar agrupamento definido no locale de dígitos, por exemplo 1.000.000 (o que significa que não tem efeito no locale de C/POSIX)
