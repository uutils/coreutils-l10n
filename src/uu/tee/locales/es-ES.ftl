...
tee-help-ignore-interrupts = ignorar señales de interrupción (ignorado en plataformas no-Unix)
tee-help-ignore-pipe-errors = establecer comportamiento de error de escritura (ignorado en plataformas no-Unix)
tee-help-output-error = establecer comportamiento de error de escritura
tee-help-output-error-warn = producir advertencias para errores escribiendo a cualquier salida
...
# Error messages
tee-error-stdin = error de lectura: { $error }
# Other messages
