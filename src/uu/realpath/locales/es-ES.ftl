...
realpath-help-zero = Separar nombres de archivo de salida con \0 en lugar de nueva línea
realpath-help-logical = resolver componentes '..' antes de enlaces simbólicos
realpath-help-physical = resolver enlaces simbólicos según se encuentren (predeterminado)
realpath-help-canonicalize-existing = canonicalizar siguiendo cada enlace simbólico en cada componente del nombre dado recursivamente, todos los componentes deben existir
