...
stty-about = Declarar o cambiar características del terminal.
stty-option-all = declarar todas las configuraciones actuales en forma legible por humanos
stty-option-save = declarar todas las configuraciones actuales en forma legible por stty
