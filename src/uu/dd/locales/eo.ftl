...
dd-after-help =
    ...
    - ascii : konverti de EBCDIC al Askio. This is the inverse of the ebcdic
      option. Implies conv=unblock.
    - ebcdic : konverti de Askio al EBCDIC. This is the inverse of the ascii
      option. Implies conv=block.
    - ibm : konverti de Askio al EBCDIC, applying the conventions for [, ]
